...
define(GKS_VERSION, '1.0.0');
define(GKS_PATH, 'system/modules/qwat-gks');
 ...
 */
$GLOBALS['BE_MOD']['content']['qwat-gks'] = array
(
    'tables'      => array('tl_gks_search'),
    'icon'        => GKS_PATH.'/assets/img/icon.gif',
);
 ...
 */
$GLOBALS['TL_HOOKS']['parseBackendTemplate'][] = array('GoogleKeywordSuggest', 'injectJavaScript');
